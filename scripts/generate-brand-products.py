...
def main():
    ...
    print('Wrote celima, lumiart and zafiro products.js')
    print('Celima products:', celima_js.count("'id':"))
    print('Lumiart products:', lumiart_js.count("'id':"))
    print('Zafiro products:', zafiro_js.count("'id':"))
