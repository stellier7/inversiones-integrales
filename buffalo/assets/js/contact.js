...
function greetingLine() {
  ...
  if (seller) {
    return `Hola ${seller.firstName}, quiero ser distribuidor Buffalo.`;
  }
  return 'Hola, quiero ser distribuidor Buffalo.';
}

function shortInterestMessage() {
  const seller = getActiveSeller();
  if (seller) {
    return `Hola ${seller.firstName}, me interesa ser distribuidor Buffalo.`;
  }
  return 'Hola, me interesa ser distribuidor Buffalo.';
}
