...
function greetingLine() {
  ...
  if (seller) {
    return `Hola ${seller.firstName}, quiero ser distribuidor Zafiro.`;
  }
  return 'Hola, quiero ser distribuidor Zafiro.';
}

function shortInterestMessage() {
  const seller = getActiveSeller();
  if (seller) {
    return `Hola ${seller.firstName}, me interesa ser distribuidor Zafiro.`;
  }
  return 'Hola, me interesa ser distribuidor Zafiro.';
}
