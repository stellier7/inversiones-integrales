...
function greetingLine() {
  ...
  if (seller) {
    return `Hola ${seller.firstName}, quiero ser distribuidor Celima.`;
  }
  return 'Hola, quiero ser distribuidor Celima.';
}

function shortInterestMessage() {
  const seller = getActiveSeller();
  if (seller) {
    return `Hola ${seller.firstName}, me interesa ser distribuidor Celima.`;
  }
  return 'Hola, me interesa ser distribuidor Celima.';
}
