...
const catalogSections = [
  {
    ...
    title: 'Productos Celima',
    intro: 'Estamos preparando el catálogo completo de Celima. Mientras tanto, contáctanos por WhatsApp para cotizar.',
    image: '',
    groups: [
      {
        id: 'placeholder',
        ...
        blurb: 'El catálogo de Celima estará disponible pronto. Escríbenos por WhatsApp para más información.',
      },
    ],
  },
];
...
function initCatalog() {
  ...
  tree.innerHTML = `
    <div class="catalog-placeholder">
      ...
      <p>Estamos armando el catálogo de Celima. Contáctanos por WhatsApp para cotizar productos.</p>
    </div>
  `;
}
  ...
  track.innerHTML = `
    <div class="featured-card featured-card--placeholder">
      <div class="featured-card-body">
        <div class="featured-eyebrow">Celima</div>
        <h3>Productos próximamente</h3>
        <p>El catálogo de Celima estará disponible pronto.</p>
      </div>
    </div>
  `;
}
