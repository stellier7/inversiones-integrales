...
function greetingLine() {
  ...
  if (seller) {
    return `Hola ${seller.firstName}, quiero ser distribuidor Lumiart.`;
  }
  return 'Hola, quiero ser distribuidor Lumiart.';
}

function shortInterestMessage() {
  const seller = getActiveSeller();
  if (seller) {
    return `Hola ${seller.firstName}, me interesa ser distribuidor Lumiart.`;
  }
  return 'Hola, me interesa ser distribuidor Lumiart.';
}
